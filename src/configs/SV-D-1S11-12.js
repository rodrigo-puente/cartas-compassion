const config = {
  page1: {
    ...
    items: { 
      "label": {
        is_label: true,
        content: "Escribe 2 cosas principales que aprendes de cada una de estas áreas"
      },
      "field-1-1": {
        input: true,
      ...
      "field-2": {
        is_checkbox: true,
        content: "¿Qué actitudes has aprendido al ser un niño amable?",
        options: {
          "field-2-1": {
      ...
      "field-4": {
        is_checkbox: true,
        content: "Marca hasta 3 cosas que debes hacer para cuidar tu cuerpo",
        options: {
          "field-4-1": {
      ...
      "label-2": {
        is_label: true,
        content: "Escribe qué te ha enseñado el proyecto sobre"
      },
      "field-5-1": {
        input: true,
        content: "Jesús",
