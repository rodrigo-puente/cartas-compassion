...
import SVK3S111Template from "../components/templates/SV-K-3S11-1";
import '../styles/_cartas.scss';

function SVF4S011() {
  const { userId } = useParams();
  const bgStyles = {
    backgroundImage: `url(${require(`../assets/SV-K-3S11-1.png`).default})`,
  }
      ...
      <div className="text-center header d-flex flex-column" style={bgStyles}>
        <div className="layer d-flex align-items-center justify-content-center">
          <div>
            ...
            <small>Plantilla SV-K-3S11-1</small>
          </div>
        </div>
      </div>
