...
import SVC1S116Template from "../components/templates/SV-C-1S11-6";
import '../styles/_cartas.scss';

function SVC1S116() {
  const { userId } = useParams();
  const bgStyles = {
    backgroundImage: `url(${require(`../assets/SV-C-1S11-6.png`).default})`,
  }
      ...
      <div className="text-center header d-flex flex-column" style={bgStyles}>
        <div className="layer d-flex align-items-center justify-content-center">
          <div>
            ...
            <small>Plantilla SV-C-1S11-6</small>
          </div>
        </div>
      </div>
